...
<div class="tabsAction">
	[onshow;block=begin;when [user.rights.personnalworkingboard.write;noerr]=1]
	
		[onshow;block=begin;when [object.status]=[TPersonnalWorkingBoard.STATUS_DRAFT]]
		...
		[onshow;block=begin;when [object.status]=[TPersonnalWorkingBoard.STATUS_VALIDATED]]
		...
		<!-- '-+' est l'équivalent d'un signe '<' (TBS oblige) -->
		[onshow;block=begin;when [object.status]-+[TPersonnalWorkingBoard.STATUS_REFUSED]]
