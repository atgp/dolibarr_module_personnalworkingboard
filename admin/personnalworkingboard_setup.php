...
/**
 * 	\file		admin/personnalworkingboard.php
...
require_once '../lib/personnalworkingboard.lib.php';
 ...
 * View
 */
$page_name = "PersonnalWorkingBoardSetup";
...
$head = personnalworkingboardAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
    $langs->trans("Module104931Name"),
    0,
    "personnalworkingboard@personnalworkingboard"
);
