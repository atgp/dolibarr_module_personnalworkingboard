...
/**
 * 	\file		core/triggers/interface_99_modMyodule_PersonnalWorkingBoardtrigger.class.php
 * 	\ingroup	personnalworkingboard
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modPersonnalworkingboard_Mytrigger.class.php
 ...
 * Trigger class
 */
class InterfacePersonnalWorkingBoardtrigger
{
